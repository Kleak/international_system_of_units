...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m13(length) => "${Intl.plural(length, zero: 'kilometers', one: 'kilometer', other: 'kilometers')}";

  static m14(volume) => "${Intl.plural(volume, zero: 'liters', one: 'liter', other: 'liters')}";

  static m15(length) => "${Intl.plural(length, zero: 'meters', one: 'meter', other: 'meters')}";
